...
@Component({
  selector: 'app-list-rawdata',
  templateUrl: './list-rawdata.component.html',
  styleUrls: ['./list-rawdata.component.scss']
})
export class ListRawdataComponent implements OnInit {
  MyDataSource: any;
  ...
  getListData() {
    ...
    this.dataService.getUploadedGlobalData(query).subscribe(res => {
