...
describe('GroupmangementComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [GroupmangementComponent, LoadingSpinnerComponent],
      imports: [
  ...
  it('tree nodes should be displayed properly', () => {
    groups = [
      {
        ID: '1',
        name: 'Parent',
        fully_qualified_name: 'Parent',
        scopes: ['TST', 'TES', 'TET', 'DEM'],
        num_of_child_groups: 5,
        num_of_users: 2,
      },
    ];
    ...
    const expandCollapseIcon = fixture.nativeElement.querySelector(
      '.mat-icon-rtl-mirror'
    );
    ...
    const deleteButton =
      fixture.nativeElement.querySelector('div#deleteButton');
