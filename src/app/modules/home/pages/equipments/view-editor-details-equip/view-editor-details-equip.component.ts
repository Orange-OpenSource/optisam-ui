...
@Component({
  selector: 'app-view-editor-details-equip',
  templateUrl: './view-editor-details-equip.component.html',
  styleUrls: ['./view-editor-details-equip.component.scss']
})
export class ViewEditorDetailsEquipComponent implements OnInit {
