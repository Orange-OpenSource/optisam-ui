...
@Component({
  selector: 'app-view-editor-details-agg',
  templateUrl: './view-editor-details-agg.component.html',
  styleUrls: ['./view-editor-details-agg.component.scss']
})
export class ViewEditorDetailsAggComponent implements OnInit {
